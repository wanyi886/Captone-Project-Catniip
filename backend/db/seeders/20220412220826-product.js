    ...
    return queryInterface.bulkInsert('Products', [
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/01-roundbed.webp",
        price: 87.9,
        inventory: 50,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        detail:"",
        imgUrl:"https://catniip.herokuapp.com/imgs/products/02-cat-window-perch.webp",
        price: 119.99,
        inventory: 20,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/03-Circuit-Ball-Toy-with-Scratch-Pad-copy.jpeg",
        price: 18.99,
        inventory: 20,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/04-LED-flower-fountain_hero-shot-1.jpeg",
        price: 29.99,
        inventory: 30,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/05-Catit_Creamy-Mat_Panel-1_NA-EN.jpeg",
        price: 6.99,
        inventory: 200,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/06-Catit_Catnip_Panel-1_NA-EN-1.jpeg",
        price: 8.49,
        inventory: 400,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/07-Catit_Catnip-Spray_Panel-1_NA-EN.jpeg",
        price: 8.49,
        inventory: 20,
        createdAt: new Date(),
        updatedAt: new Date(),
...

      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/08-foldable-backpack.webp",
        price: 119.99,
        inventory: 20,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/09-TravelCarrier_Spruce_Dog_05_Web_800x1000_crop_center.webp",
        price: 125.5,
        inventory: 200,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/10-Catit_Stacking_SQUARE_Tower_Panel-1_NA-EN.jpeg",
        price: 249.99,
        inventory: 1000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/11-Pet-NMN.webp",
        price: 49.9,
        inventory: 10,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/12-salmon-jerky.webp",
        price: 9.9,
        inventory: 50,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        detail:"Feed as a healthy treat for your cat, break into pieces for small cats and always monitor your pet while treating. Fresh drinking water should always be available.",
        imgUrl:"https://catniip.herokuapp.com/imgs/products/13-salmonpatesmall_1080x.webp",
        price: 6.9,
        inventory: 80,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/14-TC_AfterDark_Chicken.png",
        price: 5.9,
        inventory: 80,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        detail:"Recommendations vary greatly, based on your cat’s age, activity level and life stage. For adult cats, feed approximately 2-3 cans/pouches per day per 7 lbs. of body weight. For kittens, offer food several times a day, feed up to twice this amount.",
        imgUrl:"https://catniip.herokuapp.com/imgs/products/15-Tiki-Cat-Aloha-Friends-3-oz.-can-12-TR-Tuna-Calamari-Pumpkin-1.png",
        price: 8.9,
        inventory: 80,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/16-WRV_KITTEN-CHICKEN_3.0OZ-CAN-01-WEB-1024x1024.jpg",
        price: 8.9,
        inventory: 80,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/17-WO_VM_Studio_PDP_Bowl_Lilac_03_Web_2_7471908d-8095-411b-90b4-eeb6e8b73f62_800x1000_crop_center.webp",
        price: 48,
        inventory: 1000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        detail:"5.5lb/bag",
        imgUrl:"https://catniip.herokuapp.com/imgs/products/18-super-litter.jpeg",
        price: 48,
        inventory: 50,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/19-cleaning-gloves.webp",
        price: 16.5,
        inventory: 10,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/20-house-litter-box.webp",
        price: 187.99,
        inventory: 20,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imgUrl:"https://catniip.herokuapp.com/imgs/products/21-Longhair-Grooming-Kit-1.jpeg",
        price: 39.99,
        inventory: 300,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        detail:"Made of BPA-free materials",
        imgUrl:"https://catniip.herokuapp.com/imgs/products/22-Senses-2.0-Self-Groomer.jpg",
        price: 4.99,
        inventory: 300,
        createdAt: new Date(),
        updatedAt: new Date(),
